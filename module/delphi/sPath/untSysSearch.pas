...
uses
  Winapi.Windows, Winapi.Messages, System.SysUtils, System.StrUtils, System.Classes, System.Win.Registry, System.Types,
  Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.FileCtrl, Vcl.Clipbrd, Vcl.StdCtrls,
  Vcl.ExtCtrls;
...
var
  strSelectDir   : String;
begin
  if not SelectDirectory('请选择一个文件夹：', '', strSelectDir, [sdNewUI]) then
    Exit;
